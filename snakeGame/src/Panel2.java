...
public class Panel2 extends JPanel implements ActionListener{
    ...
    int size = (width * height) / (unit * unit);  //calculating area of each box from grid total area/1 unit area
    ...
    public void checkhit() { //chk heads collision with own body parts or walls
        ...
        if (flag == false) timer.stop(); //if snake hits stop the game
    }
...
//    }
    ...
    public void gameOver(Graphics graphic){
        ...
        //drawing takes strings to draw starting position in x & the starting position y
        graphic.drawString("PRESS R to REPLAY" +score,(width-f3.stringWidth("PRESS R to REPLAY:"))/2,height/2-180);
    }
